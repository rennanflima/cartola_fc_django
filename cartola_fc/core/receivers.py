...
def publish_match_added(sender, instance: Action, created: bool, **kwargs):
    if created:
        print('Action added')
        if instance.action == Action.Actions.GOAL:
            if instance.team == instance.match.team_a:
                instance.match.team_a_goal += 1
            elif instance.team == instance.match.team_b:
                instance.match.team_b_goal += 1
            instance.match.save()
